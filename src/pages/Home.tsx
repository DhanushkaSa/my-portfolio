        ...
        <div className="fixed overflow-auto inset-0 z-0 h-full w-full px-3 py-5 md:px-5 md:py-10 [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)] text-white">
            <div className="animate-fade-in">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center space-y-6 mt-32 md:space-y-0 md:space-x-10 ">
                    {/* Profile Image */}
                    <div className="w-[180px] md:w-[250px] my-4 md:my-5 ">
                        <img src="/profile.jpg" alt="Portfolio" className="rounded-full" />
                    </div>
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <div>
                            <a href="https://drive.google.com/file/d/1i-dOconl5_2y5vbTpMCR-h6B3Q2t_Of6/view?usp=sharing"><button className="border mt-5 px-5 py-3 font-bold rounded-3xl hover:bg-white hover:text-black">Resume</button></a>
                        </div>
                    </div>
                </div>
            </div>
