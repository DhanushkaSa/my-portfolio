                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 justify-items-center">
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://www.w3schools.com/html/">
                            <img src="/src/assets/html.jpg" alt="html" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://www.w3schools.com/js/DEFAULT.asp">
                            <img src="/src/assets/javascript.png" alt="javascript" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://docs.oracle.com/javase/8/docs/api/">
                            <img src="/src/assets/java2.jpg" alt="java" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://www.w3schools.com/c/index.php">
                            <img src="/src/assets/clogo.png" alt="C" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://downloads.mysql.com/docs/mysql-tutorial-excerpt-8.0-en.a4.pdf">
                            <img src="/src/assets/mysql.png" alt="mysql" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://www.w3schools.com/python/default.asp">
                            <img src="/src/assets/python.png" alt="python" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://v3.vitejs.dev/guide/">
                            <img src="/src/assets/vite.png" alt="vite" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://www.postman.com/what-is-an-api/">
                            <img src="/src/assets/API.jpg" alt="API" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://nodejs.org/api/all.html">
                            <img src="/src/assets/node.webp" alt="node" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://maven.apache.org/guides/getting-started/maven-in-five-minutes.html">
                            <img src="/src/assets/maven.jpg" alt="maven" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://react.dev/learn">
                            <img src="/src/assets/react.jpg" alt="react" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://docs.spring.io/spring-boot/documentation.html">
                            <img src="/src/assets/springboot logo.png" alt="springboot" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://tailwindcss.com/docs/installation">
                            <img src="/src/assets/tailwind.jpg" alt="tailwind" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://www.typescriptlang.org/docs/handbook/typescript-in-5-minutes-oop.html">
                            <img src="/src/assets/typescript.jpg" alt="typescript" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                    ...
                    <div className="border w-[100px] md:w-[150px] border-black rounded-full p-2 hover:animate-flip">
                        <Link to="https://www.postman.com/what-is-an-api/">
                            <img src="/src/assets/postman.png" alt="postman" className="w-full h-full rounded-full" />
                        </Link>
                    </div>
                </div>
            </div>
